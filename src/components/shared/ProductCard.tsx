    ...
    return (
        <>
            <Link href={`/product/${product.slug}`}>
                <div className="smooth-effect mx-6 h-[280px] w-[150px] rounded-3xl pt-5 transition ease-in-out hover:-translate-y-1 hover:scale-105 md:h-[310px] md:w-[220px] lg:h-[400px] lg:w-[250px] 2xl:w-[270px]">
                    <img
